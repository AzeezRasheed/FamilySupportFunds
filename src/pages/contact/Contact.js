  ...
  return (
    <div>
      ...
      <div className="flex flex-col  justify-center m-auto mb-14  ">
        <div className=" bg-contactus   w-full lg:h-[500px]  bg-cover object-cover bg-center ">
          <div className="flex flex-col lg:p-14 md:p-14 p-14  gap-4 pt-30 lg:pt-32   items-center bg-gray-800 opacity-70 h-full w-full">
        ...
        <div className="flex flex-col  items-center max-w-[768px] m-auto w-full p-6 pl-0 pr-0 lg:p-10 md:p-10">
          <div className=" lg:h-[240px] h-full w-full   bg-[#175C0C] lg:p-4 lg:pt-6 md:text-center  p-6  gap-6 lg:gap-2 flex flex-col  ">
            <div className="flex flex-col gap-4 text-center m-auto">
              ...
              <div className="lg:w-[294px] text-center items-center m-auto w-full border border-solid border-white opacity-10 h-0 "></div>

              <div className="flex flex-col  gap-4">
                <h2 className=" text-[16px] font-sen leading-[20px] font-semibold capitalize text-white  tracking-[3px] ">
                  Monday To Friday
                </h2>
                <h2 className=" text-[16px] font-sen leading-[20px] font-semibold capitalize text-white  tracking-[3px] ">
                  9:00 AM to 8:00 PM
                </h2>
                <h2 className=" text-[16px] font-inter leading-[28px] font-normal  capitalize text-white opacity-60 tracking-[3px] ">
