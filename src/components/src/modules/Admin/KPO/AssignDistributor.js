...
import { setAddAdminOverlay } from "./actions/UsersAction";
...
const AssignDistributor = ({ action, current }) => {
  ...
  const saveDist = () => {
    ...
    selectedDist&&selectedDist?.forEach((dist) => selectedDistID.push(dist?.DIST_Code));
        ...
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            <div
              ...
              // role="form"
            >
              <div className="inline-block overflow-y-scroll scrollbar-hide pb-5 align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:mt-8 sm:align-middle w-modal">
                <div
                ...
                >
                  ...
                  <div className="mt-2 px-12">
                    <div className="justify-between items-center mb-2">
                      ...
                      >
                        {t("assign_distributors_to_this")} {userType}
                      </p>
                      <div
                        style={{
                          marginBottom: 24,
