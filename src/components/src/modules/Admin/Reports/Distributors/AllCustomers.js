...
import { filter, findLastIndex, uniqBy, sortedUniqBy } from "lodash";
import {
  ...
  const getCustTotalOrders = (CustID) => {
    ...
    const lastOrderDate =
      lastOrderIndex >= 0
        ...
        : "Not ordered yet";
    return {
      totalOrders: uniqBy(thisCustOrders, "orderId").length,
      ...
      <div className="px-10 pt-10 pb-15 md:pb-36 lg:pb-36">
        ...
        <div className="flex justify-between">
          <div className="flex gap-2 items-center font-customGilroy text-sm not-italic mt-4 mb-10">
            ...
            /<p className="font-medium text-grey-100">{t("customers")}</p>
          </div>
                ...
                <li className="flex ">
                  ...
                  >
                    <p
                      ...
                      style={{borderColor: open === 2 ?  borderActive : ""}}
                ...
                <li className="flex ">
                  ...
                  >
                    <p
                      ...
                      style={{borderColor: openTab === 3 ?  borderActive : ""}}
                ...
                <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle w-modal">
                  ...
                  <div className="border border-solid bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse gap-4">
                    {formCompleted ? (
                      ...
                      <button
                        className="bg-red-main bg-opacity-30 rounded font-customGilroy text-white text-center text-sm font-bold not-italic px-14 py-2"
