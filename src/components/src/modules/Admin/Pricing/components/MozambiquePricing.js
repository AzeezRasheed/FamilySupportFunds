...
const MozambiquePricing = ({
  ...
  const updatePriceByTyping = (south, north, centre, index) => {
    const newArray = [...updatedProducts];
    newArray[index].south = south!=null ? +south: 0;
    newArray[index].north = north != null ? +north : 0;
    newArray[index].centre = centre != null ? +centre : 0;
  ...
  const showEdited = (targetDiv, i) => {
    if (
      allProducts[i].south > updatedProducts[i].south ||
      allProducts[i].south < updatedProducts[i].south ||
      allProducts[i].north > updatedProducts[i].north ||
      allProducts[i].north < updatedProducts[i].north ||
      allProducts[i].centre > updatedProducts[i].centre ||
      allProducts[i].centre < updatedProducts[i].centre
    ) {
          ...
          <table style={{ width: "100%" }}>
            <thead className=" items-center">
              <tr>
                ...
                <th className="w-1/5">South Price</th>
                <th className="w-1/5">North Price</th>
                <th className="w-1/5">Centre Price</th>
                <th className="w-1/5"> </th>
              </tr>
            </thead>
                    ...
                    <Fade>
                      ...
                      >
                        ...
                        <ArrowEdit
                          ...
                          onClick={() => {
                            const newArray = [...updatedProducts];
                            newArray[index].south = allProducts[index].south;
                            newArray[index].north = allProducts[index].north;
                            newArray[index].centre = allProducts[index].centre;
                            setUpdatedProducts(newArray);
