...
const UnsavedExpiryChanges = () => {
  ...
  const updateDB = () => {
    ...
    inventory.post("return-product/", toDB).then((response) => {
      setApprovalModal(false);
          ...
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            >
              <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:mt-8 sm:align-middle w-modal">
                ...
                />
                <p
                  className="font-customGilroy not-italic text-base text-center font-medium"
                  style={{
                    marginTop: "1.5rem",
                    marginBottom: "1.5rem",
                  }}
                ...
                <div className="text-center">
                  <input
                    className="bg-white rounded border border-solid border-grey-25 font-customGilroy text-base font-medium not-italic py-3 mb-10 w-52 mx-auto text-center"
          ...
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            >
              <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:mt-8 sm:align-middle w-modal">
                ...
                />
                <p
                  className="font-customGilroy not-italic text-base font-medium mt-7 mb-16 text-center"
                >
